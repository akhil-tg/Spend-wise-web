        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="w-full max-w-md px-6 relative z-10">
                ...
                <div className="text-center mb-10 animate-slideDown">
                    {/* Premium logo icon */}
                    <div className="inline-flex items-center justify-center w-24 h-24 rounded-2xl bg-gradient-to-br from-amber-500/20 to-amber-600/10 mb-6 border border-amber-500/20 shadow-lg shadow-amber-500/10 animate-float">
                        <svg
                    ...
                    <h1 className="font-heading text-5xl font-bold text-white mb-3 tracking-tight">
                ...
                <div className="glass-card p-8 animate-slideUp stagger-2">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full py-4 px-6 rounded-xl bg-slate-800/80 hover:bg-slate-700/80 border border-slate-600/30 hover:border-amber-500/30 transition-all duration-300 group relative overflow-hidden"
                    >
                ...
                <div className="mt-10 grid grid-cols-3 gap-4 animate-slideUp stagger-4">
                    {[
                ...
                {/* Trust badges */}
                <div className="mt-10 flex items-center justify-center gap-6 animate-fadeIn stagger-5">
